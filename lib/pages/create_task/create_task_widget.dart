...
class _CreateTaskWidgetState extends State<CreateTaskWidget> {
  ...
  void initState() {
    ...
    _model.descCreateController ??= TextEditingController();
    _model.descCreateFocusNode ??= FocusNode();
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CREATE_TASK_arrow_back_rounded_ICN_ON_TA');
              ...
              children: [
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.descCreateController,
                              focusNode: _model.descCreateFocusNode,
                              autofocus: true,
                              autofillHints: const [AutofillHints.email],
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              keyboardType: TextInputType.emailAddress,
                              cursorColor: FlutterFlowTheme.of(context).primary,
                              validator: _model.descCreateControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CREATE_TASK_Container_uz6393qw_ON_TAP');
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CREATE_TASK_Container_nnwoo03x_ON_TAP');
                              logFirebaseEvent('Container_date_time_picker');
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('CREATE_TASK_PAGE_CONFIRM_BTN_ON_TAP');
                      logFirebaseEvent('Button_backend_call');

                      var tasksRecordReference = TasksRecord.collection.doc();
                      await tasksRecordReference.set({
                        ...createTasksRecordData(
                          taskName: _model.nameCreateController.text,
                          taskDescription: _model.descCreateController.text,
                          startDate: _model.datePicked1,
                          endDate: _model.datePicked2,
                          completed: 0,
                          taskCreator: currentUserReference,
                        ),
                        ...mapToFirestore(
                          {
                            'task_team': [currentUserReference],
                          },
                        ),
                      });
                      ...
                      await actions.scheduleNotification(
                        ...
                        _model.descCreateController.text,
